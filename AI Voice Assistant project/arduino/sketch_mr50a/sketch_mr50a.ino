...
void eye_detect(){   
 // Clears the trigPin
  ...
  long inches = duration / 74 / 2; //time convert to distance
  long cm = distance / 29 / 2; //time convert distance
  // Prints the distance on the Serial Monitor
  Serial.print(inches + " inches t"); //print the serial monitor inches
  Serial.println(cm + "cm"); //print the serial monitor cm
